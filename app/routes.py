...
def get_client(client_id: int) -> jsonify:
...
def create_client() -> Tuple[jsonify, int]:
...
def create_parking() -> Tuple[jsonify, int]:
    data = request.get_json()
    parking = Parking(
...
def enter_parking() -> Tuple[jsonify, int]:
    data = request.get_json()
...
def exit_parking() -> Tuple[jsonify, int]:
    data = request.get_json()
    client_id = data.get("client_id")
    parking_id = data.get("parking_id")
...
def get_parking(parking_id: int) -> jsonify:
